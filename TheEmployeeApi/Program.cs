...
employeeRoute.MapPost(string.Empty, async ([FromBody] CreateEmployeeRequest employeeRequest, [FromServices] IRepository<Employee> repository, IValidator<CreateEmployeeRequest> validator) =>
{
